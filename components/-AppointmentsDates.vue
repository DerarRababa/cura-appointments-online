    ...
    <div class="relative">
      <article v-swiper="swiperOption" class="relative px-6" :loadtheme="false">
        <section class="swiper-wrapper">
          <div class="swiper-slide m-1" :key="i" v-for="i in 10">
            <!-- Render original HTML in server, render Swiper in browser (client) -->
            <button
              class="px-2 py-2 cursor-pointer mt-1 bg-white shadow-md rounded-lg flex flex-col items-center"
            >
              <span class="font-semibold text-sm">WED</span>
              <span class="text-lg leading-5">14</span>
            </button>
          </div>
        </section>
      </article>
      <button class="button-prev absolute -right-4 top-7 z-10">
        <svg
          width="11"
          height="19"
          viewBox="0 0 11 19"
      ...
      <button class="button-next absolute -left-4 top-7 z-10">
        <svg
          width="11"
          height="19"
          viewBox="0 0 11 19"
